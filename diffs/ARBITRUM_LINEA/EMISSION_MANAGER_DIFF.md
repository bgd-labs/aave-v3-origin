```diff
diff --git a/./downloads/ARBITRUM/EMISSION_MANAGER.sol b/./downloads/LINEA/EMISSION_MANAGER.sol
index be75e57..9de846c 100644
...
@@ -43,7 +43,7 @@ interface IEACAggregatorProxy {
...
@@ -89,16 +89,6 @@ interface IRewardsDistributor {
...
@@ -154,6 +144,15 @@ interface IRewardsDistributor {
     address reward
...
+
    ...
    * @param asset The incentivized asset
@@ -211,16 +210,17 @@ interface IRewardsDistributor {
...
@@ -258,7 +258,7 @@ interface ITransferStrategyBase {
