```diff
diff --git a/./downloads/SONEIUM/COLLECTOR_IMPL.sol b/./downloads/LINEA/COLLECTOR_IMPL.sol
...
@@ -1600,7 +1600,6 @@ contract Collector is AccessControlUpgradeable, ReentrancyGuardUpgradeable, ICol
...
@@ -1841,3 +1840,28 @@ contract Collector is AccessControlUpgradeable, ReentrancyGuardUpgradeable, ICol
