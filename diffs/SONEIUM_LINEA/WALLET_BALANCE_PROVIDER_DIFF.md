```diff
diff --git a/./downloads/SONEIUM/WALLET_BALANCE_PROVIDER.sol b/./downloads/LINEA/WALLET_BALANCE_PROVIDER.sol
index 683ab95..d701f7f 100644
--- a/./downloads/SONEIUM/WALLET_BALANCE_PROVIDER.sol
+++ b/./downloads/LINEA/WALLET_BALANCE_PROVIDER.sol
@@ -1,7 +1,7 @@
 // SPDX-License-Identifier: BUSL-1.1
 pragma solidity ^0.8.0 ^0.8.10;
 
-// downloads/SONEIUM/WALLET_BALANCE_PROVIDER/src/contracts/dependencies/openzeppelin/contracts/Address.sol
...
-// downloads/SONEIUM/WALLET_BALANCE_PROVIDER/src/contracts/protocol/libraries/types/DataTypes.sol
+// downloads/LINEA/WALLET_BALANCE_PROVIDER/WalletBalanceProvider/src/contracts/protocol/libraries/types/DataTypes.sol
 
 library DataTypes {
   /**
@@ -272,9 +272,8 @@ library DataTypes {
...
@@ -440,11 +439,6 @@ library DataTypes {
...
-
   struct ExecuteSetUserEModeParams {
     ...
     address oracle;
@@ -551,7 +545,7 @@ library DataTypes {
   }
 }
 
-// downloads/SONEIUM/WALLET_BALANCE_PROVIDER/src/contracts/protocol/libraries/helpers/Errors.sol
+// downloads/LINEA/WALLET_BALANCE_PROVIDER/WalletBalanceProvider/src/contracts/protocol/libraries/helpers/Errors.sol
 
 /**
  * @title Errors library
@@ -652,13 +646,9 @@ library Errors {
...
-// downloads/SONEIUM/WALLET_BALANCE_PROVIDER/src/contracts/dependencies/openzeppelin/contracts/IERC20.sol
...
@@ -734,7 +724,7 @@ interface IERC20 {
   event Approval(address indexed owner, address indexed spender, uint256 value);
 }
 
-// downloads/SONEIUM/WALLET_BALANCE_PROVIDER/src/contracts/interfaces/IPoolAddressesProvider.sol
+// downloads/LINEA/WALLET_BALANCE_PROVIDER/WalletBalanceProvider/src/contracts/interfaces/IPoolAddressesProvider.sol
 
 /**
  * @title IPoolAddressesProvider
@@ -961,7 +951,7 @@ interface IPoolAddressesProvider {
   function setPoolDataProvider(address newDataProvider) external;
 }
 
-// downloads/SONEIUM/WALLET_BALANCE_PROVIDER/src/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol
...
@@ -1074,7 +1064,7 @@ library GPv2SafeERC20 {
   }
 }
 
-// downloads/SONEIUM/WALLET_BALANCE_PROVIDER/src/contracts/interfaces/IPool.sol
+// downloads/LINEA/WALLET_BALANCE_PROVIDER/WalletBalanceProvider/src/contracts/interfaces/IPool.sol
 
 /**
  * @title IPool
@@ -1257,14 +1247,6 @@ interface IPool {
...
@@ -1272,14 +1254,6 @@ interface IPool {
    */
...
@@ -1647,6 +1621,16 @@ interface IPool {
    */
...
@@ -1875,37 +1859,6 @@ interface IPool {
    */
...
-
    ...
    */
@@ -1942,7 +1895,7 @@ interface IPool {
   function getSupplyLogic() external view returns (address);
 }
 
-// downloads/SONEIUM/WALLET_BALANCE_PROVIDER/src/contracts/protocol/libraries/configuration/ReserveConfiguration.sol
...
@@ -1950,26 +1903,26 @@ interface IPool {
...
@@ -2013,7 +1966,7 @@ library ReserveConfiguration {
...
+    self.data = (self.data & LTV_MASK) | ltv;
   ...
   /**
@@ -2022,7 +1975,7 @@ library ReserveConfiguration {
...
+    return self.data & ~LTV_MASK;
   ...
   /**
@@ -2037,7 +1990,7 @@ library ReserveConfiguration {
...
@@ -2049,7 +2002,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~LIQUIDATION_THRESHOLD_MASK) >> LIQUIDATION_THRESHOLD_START_BIT_POSITION;
   ...
   /**
@@ -2064,7 +2017,7 @@ library ReserveConfiguration {
...
@@ -2076,7 +2029,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~LIQUIDATION_BONUS_MASK) >> LIQUIDATION_BONUS_START_BIT_POSITION;
   ...
   /**
@@ -2090,7 +2043,7 @@ library ReserveConfiguration {
   ) internal pure {
...
+    self.data = (self.data & DECIMALS_MASK) | (decimals << RESERVE_DECIMALS_START_BIT_POSITION);
   ...
   /**
@@ -2101,7 +2054,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~DECIMALS_MASK) >> RESERVE_DECIMALS_START_BIT_POSITION;
   ...
   /**
@@ -2111,7 +2064,7 @@ library ReserveConfiguration {
    */
...
@@ -2121,7 +2074,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~ACTIVE_MASK) != 0;
   ...
   /**
@@ -2131,7 +2084,7 @@ library ReserveConfiguration {
    */
...
@@ -2141,7 +2094,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~FROZEN_MASK) != 0;
   ...
   /**
@@ -2151,7 +2104,7 @@ library ReserveConfiguration {
    */
...
@@ -2161,7 +2114,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~PAUSED_MASK) != 0;
   ...
   /**
@@ -2178,7 +2131,7 @@ library ReserveConfiguration {
     bool borrowable
   ) internal pure {
     self.data =
...
@@ -2194,7 +2147,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~BORROWABLE_IN_ISOLATION_MASK) != 0;
   ...
   /**
@@ -2208,7 +2161,7 @@ library ReserveConfiguration {
     bool siloed
   ) internal pure {
     self.data =
...
@@ -2221,7 +2174,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~SILOED_BORROWING_MASK) != 0;
   ...
   /**
@@ -2234,7 +2187,7 @@ library ReserveConfiguration {
     bool enabled
   ) internal pure {
     self.data =
...
@@ -2246,7 +2199,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~BORROWING_MASK) != 0;
   ...
   /**
@@ -2261,7 +2214,7 @@ library ReserveConfiguration {
...
@@ -2273,7 +2226,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~RESERVE_FACTOR_MASK) >> RESERVE_FACTOR_START_BIT_POSITION;
   ...
   /**
@@ -2287,7 +2240,7 @@ library ReserveConfiguration {
   ) internal pure {
...
+    self.data = (self.data & BORROW_CAP_MASK) | (borrowCap << BORROW_CAP_START_BIT_POSITION);
   ...
   /**
@@ -2298,7 +2251,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~BORROW_CAP_MASK) >> BORROW_CAP_START_BIT_POSITION;
   ...
   /**
@@ -2312,7 +2265,7 @@ library ReserveConfiguration {
   ) internal pure {
...
+    self.data = (self.data & SUPPLY_CAP_MASK) | (supplyCap << SUPPLY_CAP_START_BIT_POSITION);
   ...
   /**
@@ -2323,7 +2276,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~SUPPLY_CAP_MASK) >> SUPPLY_CAP_START_BIT_POSITION;
   ...
   /**
@@ -2337,7 +2290,7 @@ library ReserveConfiguration {
   ) internal pure {
...
+    self.data = (self.data & DEBT_CEILING_MASK) | (ceiling << DEBT_CEILING_START_BIT_POSITION);
   ...
   /**
@@ -2348,7 +2301,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~DEBT_CEILING_MASK) >> DEBT_CEILING_START_BIT_POSITION;
   ...
   /**
@@ -2366,7 +2319,7 @@ library ReserveConfiguration {
     );
...
@@ -2379,7 +2332,7 @@ library ReserveConfiguration {
     DataTypes.ReserveConfigurationMap memory self
   ) internal pure returns (uint256) {
     return
...
+      (self.data & ~LIQUIDATION_PROTOCOL_FEE_MASK) >> LIQUIDATION_PROTOCOL_FEE_START_BIT_POSITION;
   ...
   /**
@@ -2394,7 +2347,7 @@ library ReserveConfiguration {
...
@@ -2406,7 +2359,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~UNBACKED_MINT_CAP_MASK) >> UNBACKED_MINT_CAP_START_BIT_POSITION;
   ...
   /**
@@ -2419,7 +2372,7 @@ library ReserveConfiguration {
...
@@ -2431,7 +2384,7 @@ library ReserveConfiguration {
...
+    return (self.data & ~FLASHLOAN_ENABLED_MASK) != 0;
   ...
   /**
@@ -2444,24 +2397,21 @@ library ReserveConfiguration {
     bool active
   ) internal pure {
     self.data =
...
+    return (self.data & ~VIRTUAL_ACC_ACTIVE_MASK) != 0;
   ...
   /**
@@ -2478,10 +2428,10 @@ library ReserveConfiguration {
...
@@ -2500,11 +2450,11 @@ library ReserveConfiguration {
     uint256 dataLocal = self.data;
...
@@ -2520,13 +2470,13 @@ library ReserveConfiguration {
     uint256 dataLocal = self.data;
...
-// downloads/SONEIUM/WALLET_BALANCE_PROVIDER/src/contracts/helpers/WalletBalanceProvider.sol
