import {AaveV3Linea, AaveV3Soneium} from '@bgd-labs/aave-address-book';
...
const CONTRACTS: ContractsType = {
  [Networks.SONEIUM]: {
    ...
    L2_POOL: {
      name: 'L2Pool',
      path: '/src/contracts/instances/L2PoolInstance.sol',
      address: AaveV3Soneium.POOL,
    },
    POOL_CONFIGURATOR: {
      name: 'PoolConfigurator',
      path: '/src/contracts/instances/PoolConfiguratorInstance.sol',
      address: AaveV3Soneium.POOL_CONFIGURATOR,
    },
    ORACLE: {
      name: 'AaveOracle',
      path: '/src/contracts/misc/AaveOracle.sol',
      address: AaveV3Soneium.ORACLE,
    },
    AAVE_PROTOCOL_DATA_PROVIDER: {
      name: 'AaveProtocolDataProvider',
      path: '/src/contracts/helpers/AaveProtocolDataProvider.sol',
      address: AaveV3Soneium.AAVE_PROTOCOL_DATA_PROVIDER,
    },
    ACL_MANAGER: {
      name: 'ACLManager',
      path: '/src/contracts/protocol/configuration/ACLManager.sol',
      address: AaveV3Soneium.ACL_MANAGER,
    },
    COLLECTOR: {
      name: 'Collector',
      path: '/src/contracts/treasury/Collector.sol',
      address: AaveV3Soneium.COLLECTOR,
    },
    DEFAULT_INCENTIVES_CONTROLLER: {
      name: 'RewardsController',
      path: '/src/contracts/rewards/RewardsController.sol',
      address: AaveV3Soneium.DEFAULT_INCENTIVES_CONTROLLER,
    },
    DEFAULT_A_TOKEN_IMPL: {
      name: 'AToken',
      path: '/src/contracts/instances/ATokenInstance.sol',
      address: '0xa7f516e8656dF586b357529241D71772d503E536',
    },
    DEFAULT_VARIABLE_DEBT_TOKEN_IMPL: {
      name: 'VariableDebtToken',
      path: '/src/contracts/instances/VariableDebtTokenInstance.sol',
      address: '0x25e5ED391ab7e72657a5cd7dD333f392DE0D9A01',
    },
    EMISSION_MANAGER: {
      name: 'EmissionManager',
      path: '/src/contracts/rewards/EmissionManager.sol',
      address: AaveV3Soneium.EMISSION_MANAGER,
    },
    POOL_ADDRESSES_PROVIDER_REGISTRY: {
      name: 'PoolAddressesProviderRegistry',
      path: '/src/contracts/protocol/configuration/PoolAddressesProviderRegistry.sol',
      address: AaveV3Soneium.POOL_ADDRESSES_PROVIDER_REGISTRY,
    },
    WETH_GATEWAY: {
      name: 'WrappedTokenGatewayV3',
      path: '/src/contracts/helpers/WrappedTokenGatewayV3.sol',
      address: AaveV3Soneium.WETH_GATEWAY,
    },
    WALLET_BALANCE_PROVIDER: {
      name: 'WalletBalanceProvider',
      path: '/src/contracts/helpers/WalletBalanceProvider.sol',
      address: AaveV3Soneium.WALLET_BALANCE_PROVIDER,
    },
    UI_POOL_DATA_PROVIDER: {
      name: 'UiPoolDataProviderV3',
      path: '/src/contracts/helpers/UiPoolDataProviderV3.sol',
      address: AaveV3Soneium.UI_POOL_DATA_PROVIDER,
    },
    UI_INCENTIVE_DATA_PROVIDER: {
      name: 'UiIncentiveDataProviderV3',
      path: '/src/contracts/helpers/UiIncentiveDataProviderV3.sol',
      address: AaveV3Soneium.UI_INCENTIVE_DATA_PROVIDER,
    },
    RISK_STEWARD: {
      name: 'RISK_STEWARD',
      path: '/src/contracts/RiskSteward.sol',
      address: AaveV3Soneium.RISK_STEWARD,
    },
    L2_ENCODER: {
      name: 'L2Encoder',
      path: '/src/contracts/helpers/L2Encoder.sol',
      address: '0x38dd7C602441b1E3694F6B66DAaA404A1a474b68',
    },
    BORROW_LOGIC: {
      name: 'BorrowLogic',
      path: '/src/contracts/protocol/libraries/logic/BorrowLogic.sol',
      address: '0x62325c94E1c49dcDb5937726aB5D8A4c37bCAd36',
    },
    BRIDGE_LOGIC: {
      name: 'BridgeLogic',
      path: '/src/contracts/protocol/libraries/logic/BridgeLogic.sol',
      address: '0x621Ef86D8A5C693a06295BC288B95C12D4CE4994',
    },
    CONFIGURATOR_LOGIC: {
      name: 'ConfiguratorLogic',
      path: '/src/contracts/protocol/libraries/logic/ConfiguratorLogic.sol',
      address: '0x09e88e877B39D883BAFd46b65E7B06CC56963041',
    },
    EMODE_LOGIC: {
      name: 'EModeLogic',
      path: '/src/contracts/protocol/libraries/logic/EModeLogic.sol',
      address: '0xC31d2362fAeD85dF79d0bec99693D0EB0Abd3f74',
    },
    FLASHLOAN_LOGIC: {
      name: 'FlashLoanLogic',
      path: '/src/contracts/protocol/libraries/logic/FlashLoanLogic.sol',
    ...
    POOL_LOGIC: {
      name: 'PoolLogic',
      path: '/src/contracts/protocol/libraries/logic/PoolLogic.sol',
      address: '0xf8C97539934ee66a67C26010e8e027D77E821B0C',
    },
    SUPPLY_LOGIC: {
      name: 'SupplyLogic',
      path: '/src/contracts/protocol/libraries/logic/SupplyLogic.sol',
  ...
  [Networks.LINEA]: {
    ...
    RISK_STEWARD: {
      name: 'RISK_STEWARD',
      path: 'RiskSteward/src/contracts/RiskSteward.sol',
      address: AaveV3Linea.RISK_STEWARD,
    },
    L2_ENCODER: {
      name: 'L2Encoder',
