import {AaveV3ZkSync, AaveV3Ethereum} from '@bgd-labs/aave-address-book';
...
const CONTRACTS: ContractsType = {
  [Networks.MAINNET]: {
    ...
    EMISSION_MANAGER: {
      ...
      address: AaveV3Ethereum.EMISSION_MANAGER,
    },
    POOL_ADDRESSES_PROVIDER_REGISTRY: {
      ...
      address: AaveV3Ethereum.POOL_ADDRESSES_PROVIDER_REGISTRY,
    },
    WETH_GATEWAY: {
    ...
    WALLET_BALANCE_PROVIDER: {
      ...
      address: AaveV3Ethereum.WALLET_BALANCE_PROVIDER,
    },
    ...
    BORROW_LOGIC: {
      ...
      address: AaveV3Ethereum.EXTERNAL_LIBRARIES.BORROW_LOGIC,
    },
    BRIDGE_LOGIC: {
      name: 'BridgeLogic',
      path: 'BridgeLogic/src/core/contracts/protocol/libraries/logic/BridgeLogic.sol',
      address: AaveV3Ethereum.EXTERNAL_LIBRARIES.BRIDGE_LOGIC,
    },
    CONFIGURATOR_LOGIC: {
