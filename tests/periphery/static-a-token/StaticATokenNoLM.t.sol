...
//     _skipBlocks(60);
//     assertEq(IERC20(REWARD_TOKEN).balanceOf(address(stataTokenV2)), 0);
//     assertEq(stataTokenV2.getTotalClaimableRewards(REWARD_TOKEN), 0);
//     assertEq(stataTokenV2.collectAndUpdateRewards(REWARD_TOKEN), 0);
//     assertEq(IERC20(REWARD_TOKEN).balanceOf(address(stataTokenV2)), 0);
//   }
...
//     );
//     stataTokenV2.getClaimableRewards(user, REWARD_TOKEN);
