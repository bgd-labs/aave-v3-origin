...
contract RiskSteward is Ownable, IRiskSteward {
  ...
  /// @inheritdoc IRiskSteward
  function updateCaps(IAaveV3ConfigEngine.CapsUpdate[] calldata capsUpdate) external virtual onlyRiskCouncil {
  ...
  function updateRates(
    IAaveV3ConfigEngine.RateStrategyUpdate[] calldata ratesUpdate
   ...
   */
  function _validateCapsUpdate(IAaveV3ConfigEngine.CapsUpdate[] calldata capsUpdate) internal view {
   ...
   */
  function _validateRatesUpdate(IAaveV3ConfigEngine.RateStrategyUpdate[] calldata ratesUpdate) internal view {
   ...
   * @param capsUpdate list containing the new supply, borrow caps of the assets
   */
  function _updateCaps(IAaveV3ConfigEngine.CapsUpdate[] calldata capsUpdate) internal {
    for (uint256 i = 0; i < capsUpdate.length; i++) {
      address asset = capsUpdate[i].asset;
   ...
   * @param ratesUpdate list containing the new interest rates params of the assets
   */
  function _updateRates(IAaveV3ConfigEngine.RateStrategyUpdate[] calldata ratesUpdate) internal {
    for (uint256 i = 0; i < ratesUpdate.length; i++) {
      address asset = ratesUpdate[i].asset;
   ...
   * @param collateralUpdates list containing the new collateral updates of the assets
   */
  function _updateCollateralSide(IAaveV3ConfigEngine.CollateralUpdate[] calldata collateralUpdates) internal {
    for (uint256 i = 0; i < collateralUpdates.length; i++) {
      address asset = collateralUpdates[i].asset;
