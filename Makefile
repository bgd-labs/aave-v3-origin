...
deploy-v3-batched :; forge script --zksync --system-mode=true -vvvvvvvv scripts/DeployAaveV3MarketBatched.sol --rpc-url ${net} --private-key ${PRIVATE_KEY} --sender ${SENDER} --broadcast --skip-simulation
